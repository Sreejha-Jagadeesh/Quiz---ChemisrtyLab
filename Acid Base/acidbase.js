...
const questions = [
    {
        ...
        answer: "Releases H+ ions in water",
        options: [
    ...
    {
        numb: 2,
        question: "Common acid-base indicators like phenolphthalein change color based on the solution's:",
        answer: "pH",
        options: [
            "Concentration",
            "Temperature",
    ...
    {
        numb: 3,
        question: "A pH meter is preferred over indicators because it provides:",
        answer: "Precise numerical measurement",
        options: [
            "Faster color change",
            "More vivid color indication",
            "Precise numerical measurement",
            "Wider range of detectable pH"
        ]
    },
    {
        numb: 4,
        question: "When an acid reacts with a base, a neutralization reaction occurs, producing:",
    ...
    {
        numb: 5,
        question: "Understanding acids and bases is crucial in:",
...
function showResultBox() {
    ...
    if (userScore < questions.length) {
        youtubeLinkContainer.innerHTML = `<p>Watch this video for more information:</p><a href="https://www.youtube.com/watch?v=2DmbnhZDqYI" target="_blank">Click here to watch</a>`;
    } else {
