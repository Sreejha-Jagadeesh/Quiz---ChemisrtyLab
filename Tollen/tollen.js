...
const questions = [
    {
        numb: 1,
        question: "Tollens' test detects the presence of:",
        answer: "Aldehydes",
        options: [
            "Aldehydes",
            "Carboxylic acids",
    ...
    {
        numb: 2,
        question: "The positive Tollens' test reaction involves the formation of:",
        answer: "A black precipitate",
        options: [
            "A white precipitate",
            "A colorless gas",
            "A black precipitate",
    ...
    {
        numb: 3,
        question: "A color change from colorless to silver indicates:",
        answer: "A positive Tollens' test result",
        options: [
            "A negative Tollens' test result",
            "A well-mixed solution",
            "An inconclusive test",
            "A positive Tollens' test result"
        ]
    },
    {
        numb: 4,
        question: "In a negative Tollens' test, the solution remains:",
    ...
    {
        numb: 5,
        question: "A limitation of Tollens' test is that it:",
        answer: "Can react with some ketones",
        options: [
            "Is highly sensitive",
            "Can react with some ketones",
            "Provides a confirmatory result",
            "Is easy to perform"
        ]
    }
];
...
function showResultBox() {
    ...
    if (userScore < questions.length) {
        youtubeLinkContainer.innerHTML = `<p>Watch this video for more information:</p><a href="https://www.youtube.com/watch?v=7I-y3I3VzM8&t=72s" target="_blank">Click here to watch</a>`;
    } else {
