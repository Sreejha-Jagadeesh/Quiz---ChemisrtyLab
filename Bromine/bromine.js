...
const questions = [
    {
        numb: 1,
        question: "Which of the following turns colorless when bromine water is added?",
        answer: "Ethene (alkene)",
        options: [
            "Ethanol (alkane)",
            "Ethene (alkene)",
            "Acetone (ketone)",
    ...
    {
        numb: 2,
        question: "Bromine water reacts with alkenes due to:",
    ...
    {
        numb: 3,
        question: "To distinguish between an alkene and an alkane using bromine water, you would observe:",
        answer: "Color change only for the alkene",
        options: [
            "Color change only for the alkene",
            "Fizzing only for the alkane",
            "Precipitate formation only for the alkene",
            "No reaction for either"
        ]
    },
    {
        numb: 4,
        question: "When handling bromine water, it's important to:",
        answer: "Work in a well-ventilated area",
        options: [
            "Touch it with bare hands",
            "Work in a well-ventilated area",
            "Mix it with concentrated acids",
            "Store it in unlabeled containers"
        ]
    },
    {
        numb: 5,
        question: "Bromine water can be used in a lab to:",
        answer: "Test for unsaturation in organic compounds",
        options: [
            "Measure pH",
...
function showResultBox() {
    ...
    if (userScore < questions.length) {
        youtubeLinkContainer.innerHTML = `<p>Watch this video for more information:</p><a href="https://www.youtube.com/watch?v=vBMGNzRYngk" target="_blank">Click here to watch</a>`;
    } else {
